...
3) Upload the "phpmailer" folder to your server inside mailjet_extension_path/Resources/Private/Libraries!    
Example : typo3conf/ext/mailjet/Resources/Private/Libraries
4) Check if the 'phpmailer' is properly installed by submitting a test email from a subscription form. You should also check the field of your admin panel for extension - Send emails through Mailjet and
Allow HTML
5) The end
